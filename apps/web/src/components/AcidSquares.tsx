...
const stepsFor = (detail: 'low' | 'medium' | 'high'): number => DETAIL_STEPS[detail] || DETAIL_STEPS.medium
...
type AcidSquaresContext = { renderer: Renderer; program: Program; mesh: Mesh }

const ctxMap = new WeakMap<HTMLElement, AcidSquaresContext>()
